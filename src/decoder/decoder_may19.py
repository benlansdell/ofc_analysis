...
# Train on days 2 and 6, test on day 6. As a comparison. 
...
fn_out_d6 = './decoder_day6_results_may19.csv'
fn_out_ave_d6_results = './decoder_day6_results_average_over_folds_may19.csv'
results_d6[0].to_csv(fn_out_d6)

with open('day6results_may19.pkl', 'wb') as f:
