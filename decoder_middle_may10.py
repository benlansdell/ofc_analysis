...
fn_in = './data/processed/full_middle.csv'
...
df = df[['Animal', 'Session', 'CellID', 'RewardStatus', 'Trial', 'recording',
         'Reward', 'MatchID', 'treatment', 'variable', 'value']]
...
label_key = {'reward_middle_events': 1, 'unreward_middle_events': 0}
...
def run_analysis(t_min, t_max, classifier, param_grid, train_sessions, test_session, test_idx, 
    ...
    for treatment in conditions:
        ...
        for animal in animals:
            ...
            #check if df_con.variable is numeric or not, if not, convert to numeric
            if df_con.variable.dtype == 'O':
                df_con.variable = df_con.variable.str.extract('(\d+)', expand=False).astype(int)
...
ave_resultsday7, day7results, results_d7 = run_decoder(time_pairs, 
                                                       test_pairs, 
                                                       classifiers, 
                                                       grids, 
                                                       train_sessions, 
...
ave_resultsday9, day9results, results_d9 = run_decoder(time_pairs, 
                                                       test_pairs, 
                                                       classifiers, 
                                                       grids, 
                                                       train_sessions, 
...
fn_out_d2 = './decoder_day2_results_may10_middle.csv'
fn_out_d6 = './decoder_day6_results_may10_middle.csv'
fn_out_ave_d2_results = './decoder_day2_results_average_over_folds_may10_middle.csv'
fn_out_ave_d6_results = './decoder_day6_results_average_over_folds_may10_middle.csv'
results_d2[0].to_csv(fn_out_d2)
results_d6[0].to_csv(fn_out_d6)

with open('day2results_may10_middle.pkl', 'wb') as f:
    pickle.dump(day2results, f)

with open('day6results_may10_middle.pkl', 'wb') as f:
    pickle.dump(day6results, f)

fn_out_d7 = './decoder_day7_results_may10_middle.csv'
fn_out_d9 = './decoder_day9_results_may10_middle.csv'
fn_out_ave_d7_results = './decoder_day7_results_average_over_folds_may10_middle.csv'
fn_out_ave_d9_results = './decoder_day9_results_average_over_folds_may10_middle.csv'
results_d7[0].to_csv(fn_out_d7)
results_d9[0].to_csv(fn_out_d9)

with open('day7results_may10_middle.pkl', 'wb') as f:
    pickle.dump(day7results, f)

with open('day9results_may10_middle.pkl', 'wb') as f:
